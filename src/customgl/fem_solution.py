...
from .plugins.scenewithfemsolution import SceneWithFemSolution
...
_SCENE_CLASSES = {"Scene1": Scene1, "Scene3": Scene3, "Scene4": SceneWithFemSolution, "SceneWithFemSolution": SceneWithFemSolution}
...
class GLWidget(QOpenGLWidget):
    ...
    def initializeGL(self):
        ...
        self.rgb_renderer = RGBRendererWithMeshLines(n_lights=(self.light_config.num_directional_lights, self.light_config.num_point_lights))
